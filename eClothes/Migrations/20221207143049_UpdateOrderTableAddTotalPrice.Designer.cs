...
namespace eClothes.Migrations
{
    ...
    [Migration("20221207143049_UpdateOrderTableAddTotalPrice")]
    partial class UpdateOrderTableAddTotalPrice
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eClothes.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("eClothes.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("eClothes.Models.Order", b =>
                {
                    b.HasOne("eClothes.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("eClothes.Models.OrderItem", b =>
                {
                    ...
                    b.HasOne("eClothes.Models.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("eClothes.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
